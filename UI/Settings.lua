...
function ST.Refresh()
    ...
    for _, cat in ipairs(cats) do
        ...
        local eFS = editBtn:CreateFontString(nil, "OVERLAY", "GameFontNormal")
        eFS:SetAllPoints() eFS:SetText("E") eFS:SetTextColor(0.5, 0.5, 0.65)
        editBtn:SetScript("OnEnter", function() eFS:SetTextColor(0.3, 0.7, 1) end)
        editBtn:SetScript("OnLeave", function() eFS:SetTextColor(0.5, 0.5, 0.65) end)
        local catID = cat.id
        ...
        local dFS = delBtn:CreateFontString(nil, "OVERLAY", "GameFontNormal")
        dFS:SetAllPoints() dFS:SetText("X") dFS:SetTextColor(0.6, 0.4, 0.4)
        delBtn:SetScript("OnEnter", function() dFS:SetTextColor(1, 0.3, 0.3) end)
        delBtn:SetScript("OnLeave", function() dFS:SetTextColor(0.6, 0.4, 0.4) end)
