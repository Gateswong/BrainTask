...
LOCALES["enUS"] = {
    ...
    QUEST_ID_LABEL      = "Quest ID (multiple, comma-separated)",
    ENCOUNTER_ID_LABEL  = "Encounter ID (comma-separated)",
    CURRENCY_ID_LABEL   = "Currency ID (comma-separated, weekly cap)",
    BTN_SAVE            = "Save",
    BTN_CANCEL          = "Cancel",
...
LOCALES["zhCN"] = {
    ...
    TRACK_BOSS          = "副本 Boss",
    TRACK_CURRENCY      = "货币上限",
    QUEST_ID_LABEL      = "Quest ID（多个用逗号分隔）",
    ENCOUNTER_ID_LABEL  = "Encounter ID（逗号分隔多个）",
    CURRENCY_ID_LABEL   = "Currency ID（逗号分隔，检测周上限）",
    BTN_SAVE            = "保存",
    BTN_CANCEL          = "取消",
...
LOCALES["zhTW"] = {
    ...
    TRACK_BOSS          = "副本 Boss",
    TRACK_CURRENCY      = "貨幣上限",
    QUEST_ID_LABEL      = "Quest ID（多個以逗號分隔）",
    ENCOUNTER_ID_LABEL  = "Encounter ID（以逗號分隔）",
    CURRENCY_ID_LABEL   = "Currency ID（逗號分隔，檢測週上限）",
    BTN_SAVE            = "儲存",
    BTN_CANCEL          = "取消",
